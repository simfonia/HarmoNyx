(function (Blockly) {
  ...
  Object.assign(Blockly.Msg, {
    "HARMONYX_RUN": "Run Code",
    "HARMONYX_STOP": "Stop Audio",
    "HARMONYX_NEW": "New Project",
    "HARMONYX_EXAMPLES": "Examples",
    "HARMONYX_OPEN": "Open Project",
    "HARMONYX_SAVE": "Save Project",
    "HARMONYX_SETTINGS": "Settings",
    "HARMONYX_OPEN_SAMPLES": "Open Sound Samples Folder",
    "HARMONYX_SET_PATH": "Set processing-java Path",
    "HARMONYX_RESTART_AUDIO": "Restart Audio Engine",
    "HARMONYX_LANG_SETTING": "Language Setting",
    "HARMONYX_UNTITLED": "Untitled Project",
    "HARMONYX_UPDATE_CHECK": "Checking for updates...",
    "HARMONYX_UPDATE_AVAILABLE": "New version available!",
    "HARMONYX_UPDATE_DOWNLOADING": "Downloading update...",
    "HARMONYX_UPDATE_READY": "Update ready, click to restart",
    "HARMONYX_UPDATE_NONE": "Already up to date",
